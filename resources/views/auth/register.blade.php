<x-user-form-layout>
    ...
    <div class="w-full max-w-sm">
        <form action="/register" method="POST" class="bg-white shadow-md rounded px-6 pt-5 pb-6">
            ...
            <p class="text-sm text-center text-[#64748B] font-sans mt-2 mb-4">
                Silahkan isi informasi di bawah ini untuk membuat akun baru.
            </p>
            @csrf
            <x-form-field label="Nama" name="name" type="text" placeholder="Masukan nama anda" class="text-sm" />
            ...
            <x-form-button value="Register" class="text-sm"></x-form-button>

            <div class="flex justify-center mt-3">
                <span class="text-xs text-gray-700 font-semibold">
                    Sudah memiliki akun? <a href="/login" class="text-xs text-[#9747FF] hover:underline">Login</a>
                </span>
            </div>
        </form>
    </div>
